...
def _patch_protracker_none():
    """Patch _try_protracker to return None, forcing Stratz fallback."""
    factory = lambda: lambda *a, **kw: AsyncMock(return_value=None)  # noqa: E731
    return patch("services.build._try_protracker", new_callable=factory)
